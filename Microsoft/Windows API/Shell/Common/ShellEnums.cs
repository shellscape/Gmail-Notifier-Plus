...
namespace Microsoft.WindowsAPI.Shell
{
    ...
    /// <summary>
    /// Provides a set of flags to be used with <see cref="Microsoft.WindowsAPI.Shell.SearchCondition"/> 
    /// to indicate the operation in <see cref="Microsoft.WindowsAPI.Shell.SearchConditionFactory"/> methods.
    /// </summary>
    ...
    /// <summary>
    /// Set of flags to be used with <see cref="Microsoft.WindowsAPI.Shell.SearchConditionFactory"/>.
    /// </summary>
    public enum SearchConditionType
    {
        ...
        /// constant value using a <see cref="Microsoft.WindowsAPI.Shell.SearchConditionOperation"/>.
        /// </summary>
        Leaf = 3,
    }
