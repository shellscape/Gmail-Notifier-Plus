...
#pragma warning disable 108
    ...
    interface IThumbnailCache
    {
        ...
        [In] Microsoft.WindowsAPI.Shell.ShellNativeMethods.ThumbnailOptions flags,
        [Out] out ISharedBitmap ppvThumb,
        [Out] out Microsoft.WindowsAPI.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags,
        [Out] Microsoft.WindowsAPI.Shell.ShellNativeMethods.ThumbnailId pThumbnailID);

        void GetThumbnailByID([In] Microsoft.WindowsAPI.Shell.ShellNativeMethods.ThumbnailId thumbnailID,
        [In] uint cxyRequestedThumbSize,
        [Out] out ISharedBitmap ppvThumb,
        [Out] out Microsoft.WindowsAPI.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags);
    }
