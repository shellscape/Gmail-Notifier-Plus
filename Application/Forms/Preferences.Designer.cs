namespace GmailNotifierPlus.Forms {
	partial class Preferences {
		...
		private void InitializeComponent() {
			...
			this._LabelInterval.TabIndex = 6;
			...
			this._LabelBrowser.TabIndex = 30;
			...
			this._LabelAddress.TabIndex = 27;
			...
			this._PanelAccountGlyph.TabIndex = 16;
			// 
			...
			this._ButtonAccountCancel.TabIndex = 15;
			...
			this._ButtonAccountAction.TabIndex = 14;
