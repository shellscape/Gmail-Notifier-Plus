...
namespace GmailNotifierPlus.Utilities {
	...
	public class ImageHelper {
      ...
      Graphics graphics = Graphics.FromImage(bitmap);
			Font font = new Font("Segoe UI", 11, FontStyle.Bold, GraphicsUnit.Point, 0);
    ...
    private static void DrawShadow(ref Graphics graphics, ref Font font, String text) {
			...
			//The shadow is drawn
			g.DrawString(text, font, new SolidBrush(Color.FromArgb(100, Color.Black)), 10, 10, StringFormat.GenericTypographic);
			...
			//The shadow is drawn
			g.DrawString(text, font, Brushes.Black, 10, 10, StringFormat.GenericTypographic);
			...
			graphics.DrawString(text, font, Brushes.White, 10, 10, StringFormat.GenericTypographic);
